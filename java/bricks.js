function drawIt(){
 ...
 //PADDLE
  ...
  function onMouseMove(evt) {
      if (evt.pageX > canvasMinX+100 && evt.pageX < canvasMaxX) {
        paddlex = evt.pageX - canvasMinX-100;
      }
  }
...
//Dimenzije canvas
    ...
    function draw() {
      //izris zoge
			...
			ctx.fillStyle="red";
      //izris polja
			rect(paddlex, 600-paddleh, paddlew, paddleh);
...
//pojavno Okno ob zmagi
      ...
      swal({title: "YOU WON", text: "You have reached 25 points! ", type: 
